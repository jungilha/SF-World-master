function hor_AF = computeHorizontalDDfromTheta(ManhattanDirection_Aux, thetas)
...
% 
% 
beta = asin(ManhattanDirection_Aux(3));
alpha = atan(ManhattanDirection_Aux(2)/ManhattanDirection_Aux(1));
