function [R_cM_final, clusteredLineIdx_final,maxVoteSumIdx] = detectOrthogonalLineRANSAC_MNPL(planeNormalVector, lines, Kinv, cam, optsLAPO)
...
%sampleIdx = 1; %820 4; %441 1;
%sampleIdx = 1; %L2
sampleIdx = 12; %L1 2
sampleIdx = 11; %L1 2
sampleIdx = 3; %GS
sampleIdx = 10; %GS
%sampleIdx = 3; %R_Ncheck
%sampleIdx = 5;
...
if (isSolutionFound == 1)
    ...
    if (isempty(clusteredLineIdx{1}) && isempty(clusteredLineIdx{2}) && isempty(clusteredLineIdx{3}))
        R_cM_final = zeros(3);
