...
for imgIdx = startAt:M
    ...
    newRow = [49.7882147024505 1364.04725787631 1002.50700116686 702.016919486581 0 0 0];
    lines(end+1, :) = newRow;

    
    if(imgIdx == 714 || imgIdx == 716 || imgIdx == 718 || imgIdx == 153 || imgIdx == 155 || imgIdx == 158)
        continue;
    end
