function [optsLPIC] = load_param_LPIC_ASTRA
...
optsLPIC.lineLength = 150; 

optsLPIC.lineInlierThreshold = 18.0;
...
optsLPIC.maximumDepth = 15.0;
optsLPIC.planeInlierThreshold = 0.02; %0.02
optsLPIC.cellsize = 5;
optsLPIC.minSampleRatio = 0.04;         %0.1

optsLPIC.numInitialization = 200;
optsLPIC.iterNum = 200;
optsLPIC.convergeAngle = deg2rad(0.005); %0.001
