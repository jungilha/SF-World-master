function [R_final, R_SLP, pNV] = seekSanFranciscoWorld_MNPL_VGA(imageCurForLine, imageCur, depthCur,lines, cam, optsLPIC)
...
h1 = figure(4);
plot_unit_sphere(1, 18, 0.8); hold on; axis equal;
