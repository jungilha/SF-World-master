function [R_cM_final, clusteredLineIdx_final, commonZeroIndices] = detectOrthogonalLineRANSAC_ODEP(planeNormalVector, lines, Kinv, cam, optsLAPO)
...
if (isSolutionFound == 1)
    ...
    % get clustered lines
    [~, clusteredLineIdx, commonZeroIndices] = computeOrthogonalDistance(max_R_cM, lineEndPixelPoints, centerPixelPoint, lineLength, cam, optsLAPO);
