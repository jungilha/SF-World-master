function [R_cM, vpInfo, planeNormalVector, surfaceNormalVector, surfacePixelPoint] = seekManhattanWorld_normalRANSAC(imageCurForLine, imageCur, depthCur, cam, optsLAPO)
...
[sNV, sPP] = estimateSurfaceNormalGradient(imageCur, depthCur, cam, optsLAPO);
...
% do 1-line RANSAC
[R_cM, clusteredLinesIdx] = detectOrthogonalLineRANSAC_ODEP_normalRANSAC(planeNormalVector, lines, Kinv, cam, optsLAPO);
linesVP = cell(1,3);
for k = 1:3
