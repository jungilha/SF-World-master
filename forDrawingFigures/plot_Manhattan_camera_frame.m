...
% camera orientation
camDir = R_gnew_g * R_gc * [1.5 0 0 0; 0 1.5 0 0; 0 0 1.5 0];
plot3([camDir(1,1) camDir(1,4)], [camDir(2,1) camDir(2,4)], [camDir(3,1) camDir(3,4)], 'r', 'LineWidth', 6.0);
plot3([camDir(1,2) camDir(1,4)], [camDir(2,2) camDir(2,4)], [camDir(3,2) camDir(3,4)], 'g', 'LineWidth', 6.0);
plot3([camDir(1,3) camDir(1,4)], [camDir(2,3) camDir(2,4)], [camDir(3,3) camDir(3,4)], 'b', 'LineWidth', 6.0);
...
for k = 1:3
    ...
    plot3(vpDir(1,:), vpDir(2,:), vpDir(3,:), 'Color', vpColors(k,:), 'LineWidth', 1.5);
