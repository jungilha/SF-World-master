function [R_final, R_SLP, pNV] = seekSanFranciscoWorld_L2(imageCurForLine, imageCur, depthCur,lines, cam, optsLPIC)
...
[R, clusteredLinesIdx,maxVoteSumIdx] = detectOrthogonalLineRANSAC_L2(planeNormalVector, lines, Kinv, cam, optsLPIC);
figure(2);
