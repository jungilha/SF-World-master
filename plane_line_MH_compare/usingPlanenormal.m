...
Kinv = inv(cam);
imageCurforLine=imread("22_color.png");
depthCur=imread("22.png");
...
[planeNormalVector, planePixelPoint] = estimatePlaneNormalRANSAC_iphone(imageCur, depthCur, cam);
...
f = FigureRotator(gca());
for k = 1:3
    plot3([0 R(1,1)],[0 R(2,1)],[0 R(3,1)], 'Color' ,'r','LineWidth', 5); hold on;
