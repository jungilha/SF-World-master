function [R_cM_final, clusteredLineIdx_final ,R_SLP, maxVoteSumIdx,ransacIterCnt] = detectOrthogonalLine2RANSAC_ODEP(R_cM_old, planeNormalVector, alpha, pNVIdx, lines, Kinv, cam, optsLAPO, imageCurForLine,imgIdx)
...
while (true)
    ...
    if( pNVIdx == 1 )
        ...
        if(imgIdx ==1127)
            [corrIdx2, ~, find_Idx] = identyfyVP_large(R_cM_old_MH, pNVIdx, VP2);
        end
