function [surfaceNormalVector, surfacePixelPoint] = estimateSurfaceNormalGradient(imageCur, depthCur, cam, optsLAPO)

% assign current image pyramid
L = optsLAPO.imagePyramidLevel;
K = cam.KD_pyramid(:,:,L);
cellsize = optsLAPO.cellsize;
minDepth = optsLAPO.minimumDepth;
maxDepth = optsLAPO.maximumDepth;
...
cellCount = 0;
for v = (cellsize+1):imageHeight-cellsize
    for u = (cellsize+1):imageWidth-cellsize
